...
function calculator() {
  ...
  getStaticInformaion(".calculating__choose_big div", "calculating__choose-item_active");
...
function slider(_ref) {
  ...
  function refreshSliderPageCounter() {
    let functionality = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
